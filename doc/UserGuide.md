...
### Adding a person: `add`
Adds a person to the address book and then invokes the [list](UserGuide.md#listing-all-persons--list) command.<br>
...
Sorts the list of all persons in the address book by alphabetical order of their names and
then invokes the [list](UserGuide.md#listing-all-persons--list) command.<br>
Format: `sort`
...
Deletes the specified person from the address book and then invokes the [list](UserGuide.md#listing-all-persons--list) command.. Irreversible.<br>
Format: `delete INDEX`
